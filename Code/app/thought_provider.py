...
def build_thought_context(agent_state: AgentState, baseline_thought: ThoughtResult) -> dict:
    ...
    return {
        ...
        "schema": {
            "primary_goal": "survive|rest|get_food|produce|heal|patrol|trade|seek_help|help_other|hunt|avoid_threat|maintain_relationship|investigate|report",
            ...
            "candidate_actions": "1..5 sorted by score descending. action_type must be idle|rest|move|chat|talk|help|patrol|gather|hunt|eat|flee|trade|plant|forge|heal|investigate|warn|report",
        ...
        "hard_rules": [
            ...
            "Use identity/profession/skills as capability signals; legacy role is only a compatibility hint.",
